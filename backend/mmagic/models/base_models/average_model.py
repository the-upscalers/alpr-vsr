...
class ExponentialMovingAverage(BaseAveragedModel):
    ...
    def avg_func(
        ...
        Args:
            ...
            steps (int): The number of times the parameters have been
                updated.
        """
        averaged_param.mul_(1 - self.momentum).add_(source_param, alpha=self.momentum)
    ...
    def _load_from_state_dict(
        ...
        for key, value in list(state_dict.items()):
            ...
            if (
                ...
                and not key[len(prefix) :].startswith("module")
    ...
    def sync_parameters(self, model: nn.Module) -> None:
        ...
        avg_param = itertools.chain(self.module.parameters(), self.module.buffers())
    ...
    def avg_func(
        ...
        Args:
            ...
            steps (int): The number of times the parameters have been
                updated.
        """
        momentum = 1.0 - self.rampup(
            self.steps, self.ema_kimg, self.ema_rampup, self.batch_size, self.eps
        )
        if not (0.0 < momentum < 1.0):
            warnings.warn(
                "RampUp momentum must be in range (0.0, 1.0)" f"but got {momentum}"
            )
